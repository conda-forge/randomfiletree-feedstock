...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/randomfiletree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12682&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/randomfiletree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `randomfiletree` can be installed with:

```
conda install randomfiletree
```

It is possible to list all of the versions of `randomfiletree` available on your platform with:
